...
var _Relation = __webpack_require__(148);
...
jsBridge.ready(function () {
  var relation = migi.preExist(migi.createCp(_Relation2.default, []), '#page');
  _net2.default.postJSON('/h5/my/relation', function (res) {
    if (res.success) {
...
module.exports = __webpack_require__.p + "relation.html";
...
var Relation = function (_migi$Component) {
  _inherits(Relation, _migi$Component);
  ...
  function Relation() {
    ...
    return _possibleConstructorReturn(this, (_ref = Relation.__proto__ || Object.getPrototypeOf(Relation)).call.apply(_ref, [this].concat(data)));
  }
  ...
  _createClass(Relation, [{
    ...
    value: function checkMore($window) {
      ...
      if (self.tag === 'follow') {
        ...
        var _bool = void 0;
        _bool = $window.scrollTop() + _WIN_HEIGHT + 30 > _HEIGHT;
        if (_bool) {
          self.load3();
        }
        ...
        var _WIN_HEIGHT2 = $window.height();
        var _HEIGHT2 = $(document.body).height();
        var _bool2 = void 0;
        _bool2 = $window.scrollTop() + _WIN_HEIGHT2 + 30 > _HEIGHT2;
        if (_bool2) {
          self.load4();
        }
      } else {
        ...
        var _WIN_HEIGHT3 = $window.height();
        var _HEIGHT3 = $(document.body).height();
        var _bool3 = void 0;
        _bool3 = $window.scrollTop() + _WIN_HEIGHT3 + 30 > _HEIGHT3;
        if (_bool3) {
          self.load();
        }
      }
    ...
    value: function load() {
      ...
      loading = true;
      self.message = '正在加载...';
      _net2.default.postJSON('/h5/my/friendList', { skip: skip, take: take }, function (res) {
        if (res.success) {
          var data = res.data;
          skip += take;
          var s = '';
    ...
    value: function load2() {
      ...
      _net2.default.postJSON('/h5/my/followList', { skip: skip2, take: take }, function (res) {
        if (res.success) {
          var data = res.data;
          skip2 += take;
          var s = '';
    ...
    value: function load3() {
      ...
      _net2.default.postJSON('/h5/my/followerList', { skip: skip3, take: take }, function (res) {
        if (res.success) {
          var data = res.data;
          skip3 += take;
          var s = '';
    ...
    value: function load4() {
      ...
      _net2.default.postJSON('/h5/my/followerAuthor', { skip: skip4, take: take }, function (res) {
        if (res.success) {
          var data = res.data;
          skip4 += take;
          var s = '';
    ...
    value: function genItem(item) {
      return migi.createVd("li", [], [migi.createVd("a", [["href", '/user.html?userID=' + item.UserID], ["class", "pic"], ["title", item.UserNickName]], [migi.createVd("img", [["src", _util2.default.autoSsl(_util2.default.img120_120_80(item.User_HeadUrl || '/src/common/head.png'))]])]), migi.createVd("a", [["href", '/user.html?userID=' + item.UserID], ["class", "txt"], ["title", item.AuthorName]], [migi.createVd("span", [["class", "name"]], [item.UserNickName])])]);
    }
  }, {
    key: 'genAuthor',
    value: function genAuthor(item) {
      return migi.createVd("li", [], [migi.createVd("a", [["href", '/author.html?authorID=' + item.AuthorID], ["class", "pic"], ["title", item.AuthorName]], [migi.createVd("img", [["src", _util2.default.autoSsl(_util2.default.img120_120_80(item.Head_url || '/src/common/head.png'))]])]), migi.createVd("a", [["href", '/author.html?authorID=' + item.AuthorID], ["class", "txt"], ["title", item.AuthorName]], [migi.createVd("span", [["class", "name"]], [item.AuthorName])])]);
    }
  }, {
    key: 'clickType',
    ...
    value: function render() {
      return migi.createVd("div", [["class", new migi.Obj("tag", this, function () {
        return 'relation ' + (this.tag || '');
      })]], [new migi.Obj("hasData", this, function () {
        return this.hasData ? migi.createVd("div", [], [migi.createVd("ul", [["class", "type"], ["onClick", [[{ "span": { "_v": true } }, new migi.Cb(this, this.clickType)]]]], [migi.createVd("li", [], [migi.createVd("span", [["class", "friend cur"], ["href", "?tag=friend"], ["rel", "friends"]], ["圈友"])]), migi.createVd("li", [], [migi.createVd("span", [["class", "follow"], ["href", "?tag=follow"], ["rel", "follow"]], ["我关注的"])]), migi.createVd("li", [], [migi.createVd("span", [["class", "follower"], ["href", "?tag=follower"], ["rel", "follower"]], ["关注我的"])]), migi.createVd("li", [], [migi.createVd("span", [["class", "author"], ["href", "?tag=author"], ["rel", "author"]], ["关注作者"])])]), migi.createVd("div", [["class", "friend"]], [this.userFriends.Size ? migi.createVd("ul", [["class", "fn-clear"], ["ref", "userFriends"]], [this.userFriends.data.map(function (item) {
          return this.genItem(item);
        }.bind(this))]) : '', migi.createVd("div", [["class", "cp-message"], ["ref", "message"]], [this.message])]), migi.createVd("div", [["class", "follow"]], [this.userFollows.Size ? migi.createVd("ul", [["class", "fn-clear"], ["ref", "userFollows"]], [this.userFollows.data.map(function (item) {
          return this.genItem(item);
        }.bind(this))]) : '', migi.createVd("div", [["class", "cp-message"], ["ref", "message2"]], [this.message2])]), migi.createVd("div", [["class", "follower"]], [this.userFollowers.Size ? migi.createVd("ul", [["class", "fn-clear"], ["ref", "userFollowers"]], [this.userFollowers.data.map(function (item) {
          return this.genItem(item);
        }.bind(this))]) : '', migi.createVd("div", [["class", "cp-message"], ["ref", "message3"]], [this.message3])]), migi.createVd("div", [["class", "author"]], [this.follows.Size ? migi.createVd("ul", [["class", "fn-clear"], ["ref", "author"]], [this.follows.data.map(function (item) {
          return this.genAuthor(item);
        }.bind(this))]) : '', migi.createVd("div", [["class", "cp-message"], ["ref", "message4"]], [this.message4])])]) : migi.createVd("div", [], [migi.createVd("div", [["class", "fn-placeholder-tags"]]), migi.createVd("div", [["class", "fn-placeholder-roundlets"]])]);
      })]);
    }
  }, {
    key: 'hasData',
    ...
    key: 'tag',
    set: function set(v) {
      this.__setBind("tag", v);this.__data("tag");
    },
    get: function get() {
      return this.__getBind("tag");
    }
  }]);
...
migi.name(Relation, "Relation");exports.default = Relation;
