...
var _Private = __webpack_require__(181);
...
jsBridge.ready(function () {
  var pri = migi.preExist(migi.createCp(_Private2.default, []), '#page');
});
...
module.exports = __webpack_require__.p + "private.html";
...
var Private = function (_migi$Component) {
  _inherits(Private, _migi$Component);
  ...
  function Private() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref = Private.__proto__ || Object.getPrototypeOf(Private)).call.apply(_ref, [this].concat(data)));

    var self = _this;
    self.on(migi.Event.DOM, function () {
      _net2.default.postJSON('/h5/my/private', function (res) {
        if (res.success) {
  ...
  _createClass(Private, [{
    ...
    value: function click3() {
      ...
      jsBridge.prompt({
        ...
        if (res.success) {
          var realName = res.value;
          if (realName !== self.realName) {
            _net2.default.postJSON('/h5/my/updatePrivate', { realName: realName, phone: self.phone, address: self.address }, function (res) {
              if (res.success) {
    ...
    value: function click4() {
      ...
      jsBridge.prompt({
        ...
        if (res.success) {
          ...
          if (phone !== self.phone) {
            _net2.default.postJSON('/h5/my/updatePrivate', { realName: self.realName, phone: phone, address: self.address }, function (res) {
              if (res.success) {
                self.phone = phone;
      ...
      jsBridge.prompt({
        ...
        if (res.success) {
          ...
          if (address !== self.address) {
            _net2.default.postJSON('/h5/my/updatePrivate', { realName: self.realName, phone: self.phone, address: address }, function (res) {
              if (res.success) {
    ...
    value: function genDom() {
      var self = this;
      return migi.createVd("div", [], [migi.createVd("label", [], ["收件人："]), migi.createVd("span", [["ref", "realName"]], [self.realName]), migi.createVd("b", [["class", "edit"], ["ref", "edit3"], ["onClick", self.click3.bind(self)]]), migi.createVd("br", []), migi.createVd("label", [], ["联系手机："]), migi.createVd("span", [["ref", "phone"]], [self.phone]), migi.createVd("b", [["class", "edit"], ["ref", "edit4"], ["onClick", self.click4.bind(self)]]), migi.createVd("br", []), migi.createVd("label", [], ["收货地址："]), migi.createVd("span", [["ref", "address"]], [self.address]), migi.createVd("b", [["class", "edit"], ["ref", "edit5"], ["onClick", self.click5.bind(self)]])]);
    }
  }, {
    key: "render",
    value: function render() {
      return migi.createVd("div", [["class", "private"]], [new migi.Obj("hasData", this, function () {
        return this.hasData ? this.genDom() : migi.createVd("div", [], [migi.createVd("div", [["class", "fn-placeholder"]]), migi.createVd("div", [["class", "fn-placeholder"]])]);
      })]);
    }
  }, {
    key: "hasData",
    ...
    key: "realName",
    set: function set(v) {
      this.__setBind("realName", v);this.__data("realName");
    },
    get: function get() {
      return this.__getBind("realName");
    }
  }, {
    key: "phone",
    set: function set(v) {
      this.__setBind("phone", v);this.__data("phone");
    },
    get: function get() {
      return this.__getBind("phone");
    }
  }, {
    key: "address",
    set: function set(v) {
      this.__setBind("address", v);this.__data("address");
    },
    get: function get() {
      return this.__getBind("address");
    }
  }]);
...
migi.name(Private, "Private");exports.default = Private;
