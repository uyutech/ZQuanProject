...
var _AllAlbums = __webpack_require__(169);
...
jsBridge.ready(function () {
  var allAlbums = migi.preExist(migi.createCp(_AllAlbums2.default, []), '#page');
});
...
module.exports = __webpack_require__.p + "allalbums.html";
...
var AllAlbums = function (_migi$Component) {
  _inherits(AllAlbums, _migi$Component);
  ...
  function AllAlbums() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref = AllAlbums.__proto__ || Object.getPrototypeOf(AllAlbums)).call.apply(_ref, [this].concat(data)));

    var self = _this;
    self.on(migi.Event.DOM, function () {
      _net2.default.postJSON('/h5/find/allAlbums', { skip: skip, take: take }, function (res) {
        if (res.success) {
          skip += take;
  ...
  _createClass(AllAlbums, [{
    ...
    value: function render() {
      return migi.createVd("div", [["class", "all-albums"]], [new migi.Obj("hasData", this, function () {
...
migi.name(AllAlbums, "AllAlbums");exports.default = AllAlbums;
