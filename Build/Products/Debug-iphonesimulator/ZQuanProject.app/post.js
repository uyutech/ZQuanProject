...
jsBridge.ready(function () {
  var post = migi.preExist(migi.createCp(_Post2.default, []), '#page');
  _net2.default.postJSON('/h5/post/index', { postID: postID }, function (res) {
    if (res.success) {
...
module.exports = __webpack_require__.p + "post.html";
...
var Post = function (_migi$Component) {
  ...
  _createClass(Post, [{
    key: 'setData',
    value: function setData(postID, data) {
      var self = this;
      ...
      subCmt.on('click', function () {
        if (subCmt.to) {
          jsBridge.pushWindow('/subcomment.html?type=1&id=' + self.postID + '&cid=' + self.cid + '&rid=' + self.rid, {
            title: '评论'
          });
        } else {
          jsBridge.pushWindow('/subcomment.html?type=1&id=' + self.postID, {
      ...
      var imageView = self.ref.imageView;
    ...
    value: function load() {
      ...
      ajax = _net2.default.postJSON('/h5/post/commentList', {
        postID: self.postID,
        skip: skip,
        take: take,
        sortType: sortType,
    ...
    value: function genDom() {
      ...
      return migi.createVd("div", [], [migi.createVd("h2", [], [postData.Title]), migi.createVd("div", [["class", 'profile fn-clear' + (postData.IsAuthor ? ' author' : '')]], [postData.IsAuthor ? migi.createVd("a", [["class", "pic"], ["href", '/author.html?authorID=' + postData.AuthorID], ["title", postData.SendUserNickName]], [migi.createVd("img", [["src", _util2.default.autoSsl(_util2.default.img128_128_80(postData.SendUserHead_Url || '/src/common/head.png'))]])]) : migi.createVd("a", [["class", "pic"], ["href", '/user.html?authorID=' + postData.SendUserID], ["title", postData.SendUserNickName]], [migi.createVd("img", [["src", _util2.default.autoSsl(_util2.default.img128_128_80(postData.SendUserHead_Url || '/src/common/head.png'))]])]), migi.createVd("div", [["class", "txt"]], [migi.createVd("div", [], [postData.IsAuthor ? migi.createVd("a", [["class", "name"], ["href", '/author.html?authorID=' + postData.AuthorID], ["title", postData.SendUserNickName]], [postData.SendUserNickName]) : migi.createVd("a", [["class", "name"], ["href", '/user.html?authorID=' + postData.SendUserID], ["title", postData.SendUserNickName]], [postData.SendUserNickName]), migi.createVd("small", [["class", "time"]], [_util2.default.formatDate(postData.Createtime)])])]), migi.createVd("div", [["class", "circle"]], [migi.createVd("ul", [], [(postData.Taglist || []).map(function (item) {
        return migi.createVd("li", [], [migi.createVd("a", [["href", '/circle.html?circleID=' + item.TagID], ["title", item.TagName]], [item.TagName, "圈"])]);
      })])])]), migi.createVd("div", [["class", "wrap"]], [migi.createVd("p", [["class", "con"], ["dangerouslySetInnerHTML", html]]), postData.Image_Post ? migi.createVd("div", [["class", "imgs"]], [postData.Image_Post.map(function (item, i) {
        return migi.createVd("img", [["src", _util2.default.autoSsl(_util2.default.img720__80(item.FileUrl))], ["rel", i]]);
      })]) : '', migi.createVd("b", [["class", "arrow"]]), migi.createVd("ul", [["class", "btn"]], [migi.createVd("li", [["class", "share"], ["onClick", self.clickShare.bind(self)]], [migi.createVd("b", []), migi.createVd("span", [], ["分享"])]), migi.createVd("li", [["class", 'favor' + (self.isFavor ? ' has' : '')], ["onClick", self.clickFavor.bind(self)]], [migi.createVd("b", []), migi.createVd("span", [], [self.favorCount || '收藏'])]), migi.createVd("li", [["class", 'like' + (self.isLike ? ' has' : '')], ["onClick", self.clickLike.bind(self)]], [migi.createVd("b", []), migi.createVd("span", [], [self.likeCount || '点赞'])]), migi.createVd("li", [["class", "comment"]], [migi.createVd("b", []), migi.createVd("span", [], [postData.CommentCount || '评论'])]), postData.IsOwn ? migi.createVd("li", [["class", "del"], ["onClick", self.clickDel.bind(self)]], [migi.createVd("b", [])]) : ''])]), migi.createVd("div", [["class", "box"]], [migi.createVd("a", [["name", "comment"]]), migi.createVd("h4", [], ["回复"]), migi.createVd("div", [["class", "fn"]], [migi.createVd("ul", [["class", "type fn-clear"], ["onClick", [[{ "li": { "_v": true } }, self.switchType2.bind(self)]]]], [migi.createVd("li", [["class", "cur"], ["rel", "0"]], ["全部", migi.createVd("small", [], [replyData.Count])]), migi.createVd("li", [["rel", "1"]], ["我的"])]), migi.createVd("ul", [["class", "type2 fn-clear"], ["onClick", [[{ "li": { "_v": true } }, self.switchType.bind(self)]]]], [migi.createVd("li", [["class", "cur"], ["rel", "0"]], ["最新"]), migi.createVd("li", [["rel", "1"]], ["最热"])])]), migi.createCp(_Comment2.default, [["ref", "comment"], ["zanUrl", "/h5/post/likeComment"], ["subUrl", "/h5/post/subCommentList"], ["delUrl", "/h5/post/delComment"], ["data", replyData.data], ["message", replyData.Size && replyData.Size > 3 ? '已经到底了' : '']])]), migi.createCp(_SubCmt2.default, [["ref", "subCmt"], ["tipText", "-${n}"], ["subText", "回复"], ["readOnly", true], ["originTo", postData.SendUserNickName], ["placeholder", "交流一下吧~"]]), migi.createCp(_ImageView2.default, [["ref", "imageView"]])]);
    }
  }, {
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "post"]], [new migi.Obj("hasData", this, function () {
        return this.hasData ? this.genDom() : migi.createVd("div", [], [migi.createVd("div", [["class", "fn-placeholder-roundlet"]]), migi.createVd("div", [["class", "fn-placeholder"]]), migi.createVd("div", [["class", "fn-placeholder-pic"]])]);
      })]);
    }
  }, {
    key: 'hasData',
    ...
    key: 'postID',
    set: function set(v) {
      this.__setBind("postID", v);this.__data("postID");
    },
    get: function get() {
      return this.__getBind("postID");
    }
  }, {
    key: 'isLike',
    set: function set(v) {
    ...
    key: 'favorCount',
    set: function set(v) {
      this.__setBind("favorCount", v);this.__data("favorCount");
    },
    get: function get() {
      return this.__getBind("favorCount");
    }
  }]);
