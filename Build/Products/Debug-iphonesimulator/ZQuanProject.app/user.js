...
jsBridge.ready(function () {
  var user = migi.preExist(migi.createCp(_User2.default, []), '#page');
  _net2.default.postJSON('/h5/user/index', { userID: userID }, function (res) {
    if (res.success) {
...
var User = function (_migi$Component) {
  ...
  function User() {
    ...
    return _possibleConstructorReturn(this, (_ref = User.__proto__ || Object.getPrototypeOf(User)).call.apply(_ref, [this].concat(data)));
  }

  _createClass(User, [{
    key: 'setData',
    value: function setData(userID, data) {
      var self = this;
    ...
    value: function load() {
      ...
      _net2.default.postJSON('/h5/user/postList', { userID: self.userID, skip: skip, take: take }, function (res) {
        if (res.success) {
          var data = res.data;
          skip += take;
    ...
    value: function genDom() {
      var self = this;
      return migi.createVd("div", [], [migi.createCp(_Profile2.default, [["userInfo", self.userInfo], ["followState", self.followState]]), migi.createVd("h4", [], ["TA画的圈"]), migi.createCp(_HotPost2.default, [["ref", "hotPost"], ["dataList", self.userPost.data]]), migi.createCp(_ImageView2.default, [["ref", "imageView"]])]);
    }
  }, {
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "user"]], [new migi.Obj("hasData", this, function () {
        return this.hasData ? this.genDom() : migi.createVd("div", [], [migi.createVd("div", [["class", "fn-placeholder-tag"]]), migi.createVd("div", [["class", "fn-placeholder-roundlet"]]), migi.createVd("div", [["class", "fn-placeholder-tag"]]), migi.createVd("div", [["class", "fn-placeholder"]]), migi.createVd("div", [["class", "fn-placeholder"]])]);
      })]);
    }
  }, {
    key: 'hasData',
    ...
    key: 'userID',
    set: function set(v) {
      this.__setBind("userID", v);this.__data("userID");
    },
    get: function get() {
      return this.__getBind("userID");
    }
  }]);
  ...
  _createClass(Profile, [{
    ...
    value: function clickFollow() {
      ...
      if (self.followState === 2) {
        _net2.default.postJSON('/h5/user/follow', { userID: self.props.userInfo.UID }, function (res) {
          if (res.success) {
        ...
        _net2.default.postJSON('/h5/user/unFollow', { userID: self.props.userInfo.UID }, function (res) {
          if (res.success) {
            self.followState = res.data;
          } else if (res.code === 1000) {
            migi.eventBus.emit('NEED_LOGIN');
    ...
    value: function render() {
      return migi.createVd("div", [["class", "profile fn-clear"]], [migi.createVd("h4", [], ["TA的资料"]), migi.createVd("div", [["class", "pic"], ["onClick", new migi.Cb(this, this.clickPic)]], [migi.createVd("img", [["src", new migi.Obj("head", this, function () {
        ...
        return this.sname;
      })]), migi.createVd("p", [["class", new migi.Obj("sign", this, function () {
        return this.sign ? 'sign' : 'sign empty';
      })]], [new migi.Obj("sign", this, function () {
        return this.sign || '暂无签名';
      })])]), new migi.Obj("followState", this, function () {
        return this.followState ? migi.createVd("div", [["class", "rel"]], [migi.createVd("span", [["class", 's' + this.followState], ["onClick", new migi.Cb(this, this.clickFollow)]], [FOLLOW_STATE[this.followState]])]) : '';
      })]);
    }
  }, {
    key: 'head',
    ...
    key: 'followState',
    set: function set(v) {
      this.__setBind("followState", v);this.__data("followState");
    },
    get: function get() {
      return this.__getBind("followState");
    }
  }]);
