...
var _MyPost = __webpack_require__(157);
...
jsBridge.ready(function () {
  var myPost = migi.preExist(migi.createCp(_MyPost2.default, []), '#page');
  _net2.default.postJSON('/h5/my/postList', function (res) {
    if (res.success) {
...
module.exports = __webpack_require__.p + "mypost.html";
...
var MyPost = function (_migi$Component) {
  _inherits(MyPost, _migi$Component);
  ...
  function MyPost() {
    ...
    return _possibleConstructorReturn(this, (_ref = MyPost.__proto__ || Object.getPrototypeOf(MyPost)).call.apply(_ref, [this].concat(data)));
  }
  ...
  _createClass(MyPost, [{
    ...
    value: function load() {
      ...
      _net2.default.postJSON('/h5/my/postList', { skip: skip, take: take }, function (res) {
        if (res.success) {
          var data = res.data;
          skip += take;
    ...
    value: function genDom() {
      var self = this;
      return migi.createVd("div", [], [migi.createVd("h4", [], ["我画的圈"]), migi.createCp(_HotPost2.default, [["ref", "hotPost"], ["message", self.postList.Size <= take && self.postList.Size > 3 ? '已经到底了' : ''], ["dataList", self.postList.data]]), migi.createCp(_ImageView2.default, [["ref", "imageView"]])]);
    }
  }, {
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "mypost"]], [new migi.Obj("hasData", this, function () {
...
migi.name(MyPost, "MyPost");exports.default = MyPost;
