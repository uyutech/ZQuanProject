...
var _MyFavor = __webpack_require__(161);

var _MyFavor2 = _interopRequireDefault(_MyFavor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

jsBridge.ready(function () {
  var myFavor = migi.preExist(migi.createCp(_MyFavor2.default, []), '#page');
  _net2.default.postJSON('/h5/my/favor', function (res) {
    if (res.success) {
...
module.exports = __webpack_require__.p + "myfavor.html";
...
var MyFavor = function (_migi$Component) {
  _inherits(MyFavor, _migi$Component);
  ...
  function MyFavor() {
    ...
    return _possibleConstructorReturn(this, (_ref = MyFavor.__proto__ || Object.getPrototypeOf(MyFavor)).call.apply(_ref, [this].concat(data)));
  }
  ...
  _createClass(MyFavor, [{
    ...
    value: function load() {
      ...
      _net2.default.postJSON('/h5/my/favor', { skip: skip, take: take }, function (res) {
        if (res.success) {
          var data = res.data;
          skip += take;
    ...
    value: function load2() {
      ...
      loading2 = true;
      hotPic.message = '正在加载...';
      _net2.default.postJSON('/h5/my/favorPic', { skip: skip2, take: take2 }, function (res) {
        if (res.success) {
          var data = res.data;
          skip2 += take2;
    ...
    value: function load3() {
      ...
      _net2.default.postJSON('/h5/my/favorPost', { skip: skip3, take: take3 }, function (res) {
        if (res.success) {
          var data = res.data;
          skip3 += take3;
    ...
    value: function addPic() {
      var self = this;
      if (!self.ref.hotPic) {
        var hotPic = self.ref.hotPic = migi.render(migi.createCp(_HotPic2.default, [["ref", "hotPic"], ["dataList", self.favorPic.data], ["message", self.favorPic.Size ? '正在渲染图片' : '暂无数据']]));
    ...
    value: function addPost() {
      ...
      if (!self.ref.hotPost) {
        ...
        var hotPost = self.ref.hotPost = migi.render(migi.createCp(_HotPost2.default, [["ref", "hotPost"], ["message", message], ["dataList", self.favorPost.data]]));
    ...
    value: function genDom() {
      var self = this;
      return migi.createVd("div", [], [migi.createVd("ul", [["class", "type"], ["ref", "type"], ["onClick", [[{ "span": { "_v": true } }, new migi.Cb(this, this.click)]]]], [migi.createVd("li", [], [migi.createVd("span", [["class", "cur"], ["rel", "mv"]], ["我收藏的音乐"])]), migi.createVd("li", [], [migi.createVd("span", [["rel", "pic"]], ["我收藏的图片"])]), migi.createVd("li", [], [migi.createVd("span", [["rel", "post"]], ["我收藏的画圈"])])]), migi.createCp(_HotPlayList2.default, [["ref", "hotPlayList"], ["message", self.favorMV.Size ? '' : '暂无数据'], ["dataList", self.favorMV.data]])]);
    }
  }, {
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "myfavor"]], [new migi.Obj("hasData", this, function () {
...
migi.name(MyFavor, "MyFavor");exports.default = MyFavor;
