...
var circleID = search.circleID;

jsBridge.ready(function () {
  var circle = migi.preExist(migi.createCp(_Circle2.default, []), '#page');
  _net2.default.postJSON('/h5/circle/index', { circleID: circleID }, function (res) {
    if (res.success) {
...
module.exports = __webpack_require__.p + "circle.html";
...
var Circle = function (_migi$Component) {
  ...
  _createClass(Circle, [{
    key: 'setData',
    value: function setData(circleID, data) {
      var self = this;
    ...
    value: function load() {
      ...
      _net2.default.postJSON('/h5/circle/postList', { circleID: self.circleID, skip: skip, take: take }, function (res) {
        if (res.success) {
          var data = res.data;
          skip += take;
          if (data.data.length) {
    ...
    value: function genDom() {
      var self = this;
      return migi.createVd("div", [], [migi.createCp(_Title2.default, [["ref", "title"], ["circleDetail", self.circleDetail]]), migi.createCp(_HotPost2.default, [["ref", "hotPost"], ["dataList", self.postList.data], ["message", self.postList.Size > take ? '' : '已经到底了']]), migi.createCp(_SubCmt2.default, [["ref", "subCmt"], ["tipText", "-${n}"], ["subText", "发送"], ["readOnly", true], ["placeholder", '在' + self.circleDetail.TagName + '圈画个圈吧。小小的提示：现在可以把一个圈画在好几个圈子里哦！']]), migi.createCp(_ImageView2.default, [["ref", "imageView"]])]);
    }
  }, {
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "circle"]], [new migi.Obj("hasData", this, function () {
        return this.hasData ? this.genDom() : migi.createVd("div", [], [migi.createVd("div", [["class", "fn-placeholder-pic"]]), migi.createVd("div", [["class", "fn-placeholder"]]), migi.createVd("div", [["class", "fn-placeholder"]])]);
      })]);
    }
  }, {
    key: 'hasData',
    ...
    key: 'circleID',
    set: function set(v) {
      this.__setBind("circleID", v);this.__data("circleID");
    },
    get: function get() {
      return this.__getBind("circleID");
    }
  }]);
...
var Title = function (_migi$Component) {
  ...
  _createClass(Title, [{
    ...
    value: function click(e) {
      ...
      self.loading = true;
      _net2.default.postJSON('/h5/circle/join', { circleID: this.props.circleDetail.TagID, state: self.joined }, function (res) {
        if (res.success) {
