...
var _SubPost = __webpack_require__(131);
...
jsBridge.ready(function () {
  ...
  var subPost = migi.preExist(migi.createCp(_SubPost2.default, [["placeholder", "在转圈圈画个圈吧"]]), '#page');
  _net2.default.postJSON('/h5/subpost/index', function (res) {
    if (res.success) {
...
module.exports = __webpack_require__.p + "subpost.html";
...
var SubPost = function (_migi$Component) {
  ...
  function SubPost() {
    ...
    self.on(migi.Event.DOM, function () {
      ...
      var $label = $(self.ref.label.element);
      $label.on('click', 'li', function () {
        var $li = $(this);
        var len = $label.find('.cur,.on').length;
  ...
  _createClass(SubPost, [{
    ...
    value: function submit(e) {
      ...
      if (!self.sending && !self.invalid && !self.disableUpload) {
        ...
        _net2.default.postJSON('/h5/circle/post', { content: self.value, imgs: imgs, widths: widths, heights: heights, circleID: circleID.join(',') }, function (res) {
          if (res.success) {
            self.value = '';
            self.invalid = true;
            self.num = 0;
    ...
    value: function change(e, vd) {
      ...
      var num = MAX_IMG_NUM - self.imgNum;
      num = Math.min(3, num);
      self.disableUpload = true;
      jsBridge.album({ num: num }, function (res) {
        if (res.success) {
          res = res.base64;
          ...
          res.forEach(function (img, i) {
            ...
            _net2.default.postJSON('/h5/my/uploadPic', { img: img }, function (res) {
              if (res.success) {
                var url = res.data;
                var has = void 0;
    ...
    key: 'clickTag2',
    value: function clickTag2(e, vd, tvd) {
      this.value += tvd.props.rel;
    }
  }, {
    key: 'render',
    value: function render() {
      return migi.createVd("form", [["class", "mod-sub"], ["ref", "form"], ["onSubmit", new migi.Cb(this, this.submit)]], [migi.createVd("div", [["class", "ti"]], [migi.createVd("div", [["class", new migi.Obj("disableUpload", this, function () {
        return 'upload' + (this.disableUpload ? ' dis' : '');
      })], ["onClick", new migi.Cb(this, this.change)]], ["图片"]), migi.createVd("span", [["class", new migi.Obj("warnLength", this, function () {
      ...
      })]])]), migi.createVd("div", [["class", "ti2"]], [migi.createVd("ul", [["ref", "label"]], [new migi.Obj("to", this, function () {
        return (this.to || []).map(function (item) {
          return migi.createVd("li", [["rel", item.TagID], ["class", item.TagID.toString() === (this.props.circleID || '').toString() ? 'on' : '']], [item.TagName]);
        }.bind(this));
      })])]), migi.createVd("div", [["class", new migi.Obj("tagList", this, function () {
        return 'ti3' + (this.tagList.length ? '' : ' fn-hide');
      })], ["onClick", [[{ "li": { "_v": true } }, new migi.Cb(this, this.clickTag)]]]], [migi.createVd("ul", [], [new migi.Obj("tagList", this, function () {
        return this.tagList.map(function (item, i) {
          return migi.createVd("li", [["class", Array.isArray(item.value) ? 'more' : ''], ["i", i], ["rel", item.value]], [item.name]);
        }.bind(this));
      })])]), migi.createVd("div", [["class", new migi.Obj("tagList2", this, function () {
        return 'ti4' + (this.tagList2.length ? '' : ' fn-hide');
      })], ["onClick", [[{ "li": { "_v": true } }, new migi.Cb(this, this.clickTag2)]]]], [migi.createVd("ul", [], [new migi.Obj("tagList2", this, function () {
        return this.tagList2.map(function (item) {
          return migi.createVd("li", [["rel", item.value]], [item.key]);
        }.bind(this));
      })])]), migi.createVd("div", [["class", "c"]], [migi.createVd("textarea", [["class", "text"], ["ref", "input"], ["placeholder", new migi.Obj("placeholder", this, function () {
        return this.placeholder || '夸夸这个圈子吧';
      })], ["onInput", new migi.Cb(this, this.input)]], [new migi.Obj("value", this, function () {
        return this.value;
    ...
    key: 'tagList',
    set: function set(v) {
      this.__setBind("tagList", v);this.__data("tagList");
    },
    get: function get() {
      if (this.__initBind("tagList")) this.__setBind("tagList", []);return this.__getBind("tagList");
    }
  }, {
    key: 'tagList2',
    set: function set(v) {
      this.__setBind("tagList2", v);this.__data("tagList2");
    },
    get: function get() {
      if (this.__initBind("tagList2")) this.__setBind("tagList2", []);return this.__getBind("tagList2");
    }
  }]);
