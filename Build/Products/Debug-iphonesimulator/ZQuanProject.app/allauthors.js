...
var _AllAuthors = __webpack_require__(173);
...
jsBridge.ready(function () {
  var allauthors = migi.preExist(migi.createCp(_AllAuthors2.default, []), '#page');
});
...
module.exports = __webpack_require__.p + "allauthors.html";
...
var AllAuthors = function (_migi$Component) {
  _inherits(AllAuthors, _migi$Component);
  ...
  function AllAuthors() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref = AllAuthors.__proto__ || Object.getPrototypeOf(AllAuthors)).call.apply(_ref, [this].concat(data)));

    var self = _this;
    self.on(migi.Event.DOM, function () {
      _net2.default.postJSON('/h5/find/allAuthors', { skip: skip, take: take }, function (res) {
        if (res.success) {
          skip += take;
  ...
  _createClass(AllAuthors, [{
    ...
    value: function genDom() {
      var self = this;
      return migi.createVd("ul", [["ref", "list"], ["class", "fn-clear"]], [self.workList.map(function (item) {
    ...
    value: function render() {
      return migi.createVd("div", [["class", "all-authors"]], [new migi.Obj("hasData", this, function () {
        return this.hasData ? this.genDom() : migi.createVd("div", [], [migi.createVd("div", [["class", "fn-placeholder-roundlets"]]), migi.createVd("div", [["class", "fn-placeholder"]])]);
      }), migi.createVd("div", [["class", "cp-message"]], [new migi.Obj("message", this, function () {
        return this.message;
      })])]);
    }
  }, {
...
migi.name(AllAuthors, "AllAuthors");exports.default = AllAuthors;
