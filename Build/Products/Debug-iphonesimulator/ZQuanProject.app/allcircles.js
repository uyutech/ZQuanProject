...
var _AllCircles = __webpack_require__(177);
...
jsBridge.ready(function () {
  var allCircles = migi.preExist(migi.createCp(_AllCircles2.default, []), '#page');
});
...
module.exports = __webpack_require__.p + "allcircles.html";
...
var AllCircles = function (_migi$Component) {
  _inherits(AllCircles, _migi$Component);

  function AllCircles() {
    var _ref;

    _classCallCheck(this, AllCircles);

    for (var _len = arguments.length, data = Array(_len), _key = 0; _key < _len; _key++) {
      data[_key] = arguments[_key];
    }

    var _this = _possibleConstructorReturn(this, (_ref = AllCircles.__proto__ || Object.getPrototypeOf(AllCircles)).call.apply(_ref, [this].concat(data)));

    var self = _this;
    self.on(migi.Event.DOM, function () {
      _net2.default.postJSON('/h5/find/allCircles', { skip: skip, take: take }, function (res) {
        if (res.success) {
          skip += take;
  ...
  _createClass(AllCircles, [{
    ...
    value: function render() {
      return migi.createVd("div", [["class", "all-circles"]], [new migi.Obj("hasData", this, function () {
        return this.hasData ? this.genDom() : migi.createVd("div", [], [migi.createVd("div", [["class", "fn-placeholder-circles"]]), migi.createVd("div", [["class", "fn-placeholder"]])]);
...
migi.name(AllCircles, "AllCircles");exports.default = AllCircles;
