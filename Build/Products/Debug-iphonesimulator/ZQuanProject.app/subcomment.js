...
var _SubComment = __webpack_require__(139);

var _SubComment2 = _interopRequireDefault(_SubComment);
...
jsBridge.ready(function () {
  ...
  var subComment = migi.preExist(migi.createCp(_SubComment2.default, []), '#page');
  subComment.sid = id;
...
module.exports = __webpack_require__.p + "subcomment.html";
...
var SubComment = function (_migi$Component) {
  _inherits(SubComment, _migi$Component);

  function SubComment() {
    var _ref;

    _classCallCheck(this, SubComment);

    for (var _len = arguments.length, data = Array(_len), _key = 0; _key < _len; _key++) {
      data[_key] = arguments[_key];
    }

    var _this = _possibleConstructorReturn(this, (_ref = SubComment.__proto__ || Object.getPrototypeOf(SubComment)).call.apply(_ref, [this].concat(data)));
  ...
  _createClass(SubComment, [{
    ...
    value: function submit(e) {
      ...
      if (!self.sending && !self.invalid) {
        self.sending = true;
        _net2.default.postJSON('/h5/comment/sub', {
          content: self.value,
          id: self.sid,
          type: self.type,
          cid: self.cid,
    ...
    value: function render() {
      return migi.createVd("form", [["class", "sub-cmt"], ["ref", "form"], ["onSubmit", new migi.Cb(this, this.submit)]], [migi.createVd("div", [["class", "ti"]], [migi.createVd("span", [["class", new migi.Obj("warnLength", this, function () {
        return 'limit' + (this.warnLength ? ' warn' : '');
      })]], [migi.createVd("strong", [], [new migi.Obj("num", this, function () {
        return this.num;
      })]), " / ", MAX_TEXT_LENGTH]), migi.createVd("input", [["type", "submit"], ["class", new migi.Obj(["sending", "invalid"], this, function () {
        ...
        return this.placeholder || '请输入评论';
      })], ["onInput", new migi.Cb(this, this.input)], ["maxLength", MAX_TEXT_LENGTH]], [new migi.Obj("value", this, function () {
        return this.value;
      })])])]);
    }
  }, {
...
migi.name(SubComment, "SubComment");exports.default = SubComment;
