...
var _AllWorks = __webpack_require__(165);

var _AllWorks2 = _interopRequireDefault(_AllWorks);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

jsBridge.ready(function () {
  var allWorks = migi.preExist(migi.createCp(_AllWorks2.default, []), '#page');
});
...
module.exports = __webpack_require__.p + "allworks.html";
...
var AllWorks = function (_migi$Component) {
  _inherits(AllWorks, _migi$Component);

  function AllWorks() {
    var _ref;

    _classCallCheck(this, AllWorks);

    for (var _len = arguments.length, data = Array(_len), _key = 0; _key < _len; _key++) {
      data[_key] = arguments[_key];
    }

    var _this = _possibleConstructorReturn(this, (_ref = AllWorks.__proto__ || Object.getPrototypeOf(AllWorks)).call.apply(_ref, [this].concat(data)));

    var self = _this;
    self.on(migi.Event.DOM, function () {
      _net2.default.postJSON('/h5/find/allWorks', { skip: skip, take: take }, function (res) {
        if (res.success) {
          skip += take;
  ...
  _createClass(AllWorks, [{
    ...
    value: function render() {
      return migi.createVd("div", [["class", "all-works"]], [new migi.Obj("hasData", this, function () {
        return this.hasData ? this.genDom() : migi.createVd("div", [], [migi.createVd("div", [["class", "fn-placeholder-squares"]]), migi.createVd("div", [["class", "fn-placeholder"]])]);
...
migi.name(AllWorks, "AllWorks");exports.default = AllWorks;
