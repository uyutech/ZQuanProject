...
jsBridge.ready(function () {
  ...
  var message = migi.preExist(migi.createCp(_Message2.default, []), '#page');
...
module.exports = __webpack_require__.p + "message.html";
...
var Message = function (_migi$Component) {
  ...
  function Message() {
    ...
    return _possibleConstructorReturn(this, (_ref = Message.__proto__ || Object.getPrototypeOf(Message)).call.apply(_ref, [this].concat(data)));
  }
  ...
  _createClass(Message, [{
    ...
    value: function load() {
      ...
      _net2.default.postJSON('/h5/my/message', { skip: skip, take: take }, function (res) {
        if (res.success) {
          var data = res.data;
          skip += take;
    ...
    value: function read(data) {
      ...
      if (ids.length) {
        _net2.default.postJSON('/h5/my/readMessage', { ids: ids }, function (res) {
          if (res.success) {
    ...
    value: function genDom() {
      var self = this;
      return migi.createVd("div", [], [migi.createVd("h4", [], ["圈消息"]), migi.createCp(_Messages2.default, [["ref", "messages"], ["dataList", self.data.data]]), migi.createCp(_SubCmt2.default, [["ref", "subCmt"], ["readOnly", true], ["placeholder", "请选择留言回复"], ["subText", "发送"], ["tipText", "-${n}"]])]);
    }
  }, {
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "message"]], [new migi.Obj("hasData", this, function () {
        return this.hasData ? this.genDom() : migi.createVd("div", [], [migi.createVd("div", [["class", "fn-placeholder-tag"]]), migi.createVd("div", [["class", "fn-placeholder-roundlet"]]), migi.createVd("div", [["class", "fn-placeholder"]]), migi.createVd("div", [["class", "fn-placeholder-roundlet"]]), migi.createVd("div", [["class", "fn-placeholder"]])]);
      })]);
    }
  }, {
    key: 'hasData',
  ...
  _createClass(Messages, [{
    ...
    value: function genItem(item) {
      ...
      if (item.Send_UserISAuthor) {
        return migi.createVd("li", [["class", "author"], ["id", 'message_' + item.NotifyID]], [migi.createVd("div", [["class", "profile fn-clear"]], [migi.createVd("img", [["class", "pic"], ["src", _util2.default.autoSsl(_util2.default.img96_96_80(item.Send_UserHeadUrl || '/src/common/head.png'))]]), migi.createVd("div", [["class", "txt"]], [migi.createVd("a", [["href", '/author.html?authorID=' + item.Send_UserID], ["class", "name"], ["title", item.Send_UserName]], [item.Send_UserName]), migi.createVd("a", [["class", "time"], ["href", url], ["title", title]], [_util2.default.formatDate(item.Send_Time)])])]), migi.createVd("div", [["class", "wrap"]], [migi.createVd("a", [["class", "quote"], ["href", url], ["title", title]], [migi.createVd("label", [], [item.Action, "："]), migi.createVd("span", [], [item.Content])]), migi.createVd("pre", [["class", "con"]], [item.Send_Content]), migi.createVd("ul", [["class", "btn fn-clear"]], [migi.createVd("li", [["class", "comment"], ["type", type], ["cid", item.ParentID], ["rid", item.RootID], ["name", item.Send_UserName], ["tid", item.urlID]], ["回复"])]), migi.createVd("b", [["class", "arrow"]])])]);
      }
      return migi.createVd("li", [["id", 'message_' + item.NotifyID]], [migi.createVd("div", [["class", "profile fn-clear"]], [migi.createVd("img", [["class", "pic"], ["src", _util2.default.autoSsl(_util2.default.img96_96_80(item.Send_UserHeadUrl || '/src/common/head.png'))]]), migi.createVd("div", [["class", "txt"]], [migi.createVd("a", [["href", '/user.html?userID=' + item.Send_UserID], ["class", "name"], ["title", item.Send_UserName]], [item.Send_UserName]), migi.createVd("a", [["class", "time"], ["href", url], ["title", title]], [_util2.default.formatDate(item.Send_Time)])])]), migi.createVd("div", [["class", "wrap"]], [migi.createVd("a", [["class", "quote"], ["href", url], ["title", title]], [migi.createVd("label", [], [item.Action, "："]), migi.createVd("span", [], [item.Content])]), migi.createVd("pre", [["class", "con"]], [item.Send_Content]), migi.createVd("ul", [["class", "btn fn-clear"]], [migi.createVd("li", [["class", "comment"], ["type", type], ["cid", item.ParentID], ["rid", item.RootID], ["name", item.Send_UserName], ["tid", item.urlID]], ["回复"])]), migi.createVd("b", [["class", "arrow"]])])]);
    }
  }, {
    key: 'setData',
    value: function setData(data) {
    ...
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "cp-messages"]], [migi.createVd("ol", [["class", new migi.Obj("empty", this, function () {
        return 'list' + (this.empty ? ' fn-hide' : '');
      })], ["ref", "list"], ["dangerouslySetInnerHTML", this.html]]), migi.createVd("div", [["class", new migi.Obj("empty", this, function () {
        return 'empty' + (this.empty ? '' : ' fn-hide');
      })]], ["还没有人回复你哦~"]), migi.createVd("div", [["class", new migi.Obj("message", this, function () {
