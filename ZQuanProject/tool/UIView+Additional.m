...
-(void)setLayer:(UIView *)sview cornerRadius:(float)radius fillColor:(UIColor *)fillColor strokeColor:(UIColor *)strokeColor lineWith:(float)linewidth;
{
    CAShapeLayer *shaplayer = [CAShapeLayer layer];
    shaplayer.fillColor = fillColor.CGColor;
    shaplayer.path = [UIBezierPath bezierPathWithRoundedRect:
                          CGRectMake(0, 0, sview.width, sview.height) cornerRadius:radius].CGPath;
    shaplayer.strokeColor = strokeColor.CGColor;
    shaplayer.lineWidth = linewidth;
    [sview.layer addSublayer:shaplayer];
}
@end
